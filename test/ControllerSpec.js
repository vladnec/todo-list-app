...
describe('controller', function () {
	...
	it('should set the "clear completed" button', function () {
		var todo = {id: 15, title: 'my todo', completed: true};
		setUpModel([todo]);
	...
	describe('element removal', function () {
		it('should remove an entry from the model', function () {
			// TODO: write test
			var todo = {title: 'my todo', id:15, completed:false};
			setUpModel([]);
			subject.setView('');
			view.trigger('itemRemove', {id:15});

			expect(model.read).toHaveBeenCalledWith(jasmine.any(Function));
			expect(model.remove).toHaveBeenCalledWith(15, jasmine.any(Function));
		...
		it('should remove an entry from the view', function () {
			...
			expect(view.render).toHaveBeenCalledWith('removeItem', 15);
		});
	...
	describe('element complete toggle', function () {
		...
		it('should update the view', function () {
			...
			view.trigger('itemToggle', {id: 15, completed: false});

			expect(view.render).toHaveBeenCalledWith('elementComplete', {id: 15, completed: false});
		});
	});
